...
static dht11_t _timeoutError() {
    dht11_t timeoutError = {DHT11_TIMEOUT_ERROR, -1, -1};
    return timeoutError;
}

static dht11_t _crcError() {
    dht11_t crcError = {DHT11_CRC_ERROR, -1, -1};
    return crcError;
}
